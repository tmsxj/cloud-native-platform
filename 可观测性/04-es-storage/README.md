...
2. StatefulSet + headless Service + publishNotReadyAddresses
...
| Pod 间 DNS 不通 | headless Service 无 publishNotReadyAddresses | 加 `publishNotReadyAddresses: true` |
...
4. **为什么不用 ECK Operator**: 演示环境，理解底层手工配置比用 Operator 更能体现深度
