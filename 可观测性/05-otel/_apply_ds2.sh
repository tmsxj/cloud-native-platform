...
NS=monitoring
echo "=== /tmp/grafana-datasources.yaml contains jaeger? ==="
grep -c jaeger /tmp/grafana-datasources.yaml
echo "=== apply ==="
...
kubectl -n $NS run dscheck3 --rm -i --restart=Never --image=192.168.1.61/library/alpine_curl -- sh -c \
